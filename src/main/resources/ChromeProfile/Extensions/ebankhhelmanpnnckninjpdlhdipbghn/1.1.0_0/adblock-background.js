  ...
  chrome.runtime.onInstalled.addListener(function (details)
  {
    if (details.reason === 'install')
    {
      // ext.pages.open('');
        ...
        //открываем thanckyou page
        chrome.tabs.create({ url: "https://adsblock.best/chrome/pb/thankyou/ext.php?app=adskill", active: true });
        // открываем прощальную страницу после того как юзер решил снести расширение     
        chrome.runtime.setUninstallURL("https://adsblock.best/chrome/pb/uninstall/?app=adskill");        
